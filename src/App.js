...
function App() {
  ...
  const deletedata = (indexx) => {
    const newData = data.filter((item,index) => index !== indexx);
    setData(newData);
  ...
  return (
    <>
      ...
      <div>
        ...
        <div style={{ backgroundImage: "url(https://static.vecteezy.com/system/resources/previews/026/859/541/non_2x/of-a-cup-of-coffee-and-a-plant-next-to-a-keyboard-with-copy-space-with-copy-space-free-photo.jpg)", height: "950px", width: "100%", backgroundSize: "cover", display: "flex", justifyContent: 'center', alignItems: "center" }}>
